...
monaco.editor.defineTheme('idc-tools-dark', {
  base: 'vs-dark',
  inherit: true,
  rules: [],
  colors: {
...
monaco.editor.defineTheme('idc-tools-light', {
  base: 'vs',
  inherit: true,
  rules: [],
  colors: {
...
watch(
  ...
  isDarkTheme => monaco.editor.setTheme(isDarkTheme ? 'idc-tools-dark' : 'idc-tools-light'),
  { immediate: true },
);
